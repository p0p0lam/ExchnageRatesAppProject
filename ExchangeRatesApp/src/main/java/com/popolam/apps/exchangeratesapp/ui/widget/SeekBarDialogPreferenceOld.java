 ...
 *
 */
public class SeekBarDialogPreferenceOld extends DialogPreference
{
    private static final int DEFAULT_MIN_PROGRESS = 5;
    ...
    public SeekBarDialogPreferenceOld(Context context)
    {
        this(context, null);
    }

    public SeekBarDialogPreferenceOld(Context context, AttributeSet attrs)
    {
        super(context, attrs);
